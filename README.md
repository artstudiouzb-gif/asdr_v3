...
**Контент**
- Конструктор страниц: 41 тип блока (hero, слайдеры, галереи, FAQ,
...
├── templates/
│   ├── blocks/            # шаблоны блоков конструктора (39 файлов на 41 тип:
...
Нативный тест-раннер без PHPUnit регистрирует **1767 тестовых сценариев**;
...
| [docs/BLOCKS.md](docs/BLOCKS.md) | справочник всех 41 типа блоков и общих настроек секции |
