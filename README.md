...
**Контент**
- Конструктор страниц: 39 типов блока (hero, слайдеры, галереи, FAQ,
...
├── templates/
│   ├── blocks/            # шаблоны блоков конструктора (37 файлов на 39 типов:
...
Нативный тест-раннер без PHPUnit регистрирует **1782 тестовых сценариев**;
...
| [docs/BLOCKS.md](docs/BLOCKS.md) | справочник всех 39 типов блоков и общих настроек секции |
