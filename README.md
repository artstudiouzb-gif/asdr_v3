...
**Контент**
- Конструктор страниц: 40 типов блока (hero, слайдеры, галереи, FAQ,
...
├── templates/
│   ├── blocks/            # шаблоны блоков конструктора (38 файлов на 40 типов:
...
Нативный тест-раннер без PHPUnit регистрирует **1778 тестовых сценариев**;
...
| [docs/BLOCKS.md](docs/BLOCKS.md) | справочник всех 40 типов блоков и общих настроек секции |
