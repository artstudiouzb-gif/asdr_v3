...
final class BlockController
{
    ...
    public function update(array $params): void
    {
        ...
        // После сохранения редактор продолжает работу с тем же блоком.
        // Возврат к странице/проекту — отдельная явная кнопка в форме; если
        // отправлять туда автоматически, для следующей правки приходится
        // снова искать блок в длинном списке. Параметр нужен скрипту формы,
        // чтобы удалить уже сохранённый локальный черновик.
        header('Location: /admin/blocks/' . (int) $block['id'] . '/edit?draft_saved=block%3A' . (int) $block['id']);
        exit;
    }
