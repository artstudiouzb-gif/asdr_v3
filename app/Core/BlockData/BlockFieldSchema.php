    ...
    public static function all(): array
    {
        return self::$cache ??= [
            ...
            'advantages' => [
                'variant' => Field::enum('Вариант отображения', [
                    'grid' => 'Карточки',
                    'indexed' => 'С нумерацией',
                    'inline' => 'Иконка в строке',
                    'band' => 'Полоса',
                ], 'grid')
                ->variants([
                    'grid' => ['grid:3+icon', 'Иконка, заголовок и текст в рамке — обычный вид'],
                    'indexed' => ['grid:3+icon+num', 'То же плюс номер в углу — для шагов и принципов'],
                    'inline' => ['grid:3+icon-left', 'Иконка рядом с заголовком: карточка ниже, в ряд влезает больше'],
