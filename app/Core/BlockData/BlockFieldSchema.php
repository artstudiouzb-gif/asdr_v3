        ...
        return self::$cache ??= [
            ...
            'org_structure' => [
                ...
                'font_size' => Field::intChoice(
                    ...
                    [0, 13, 14, 16, 18, 20, 22],
                    0,
                    'Схема бывает и на десяток узлов, и на сотню: крупной она читается с проектора, мелкой помещается на экран целиком. Размеры внутри пересчитываются от этого числа и остаются в шкале темы.',
                    [0 => 'Как в теме']
                ),
