        ...
        return self::$cache ??= [
            ...
            'stages' => [
                'layout' => Field::enum('Раскладка', [
                    'track' => 'Лента карточек — этапы в ряд, прокрутка вбок',
                    'list' => 'Вертикальный список — годы слева, события справа',
            ...
            'news_feature' => [
                'variant' => Field::enum('Макет блока', [
                    ...
                    'mosaic' => 'Мозаика — ритм ленты: две крупные с текстом на фото и четыре компактные',
