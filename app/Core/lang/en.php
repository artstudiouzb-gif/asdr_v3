...
return [
    ...
    'Нет новостей.' => 'No news yet.',
    'Нет проектов.' => 'No projects yet.',
    'Список пуст.' => 'The list is empty.',
    'Страница' => 'Page',
    'Сотрудник' => 'Team member',
    'Спасибо! Ваша заявка отправлена.' => 'Thank you! Your submission has been sent.',
    'Слишком много отправок. Пожалуйста, попробуйте позже.' => 'Too many submissions. Please try again later.',
    'Неверный код с картинки. Попробуйте ещё раз.' => 'The image code is incorrect. Please try again.',
    'Код не совпал или устарел.' => 'The code is incorrect or has expired.',
    'Требуется согласие.' => 'Consent is required.',
    'Приложите файл к полю «%s».' => 'Attach a file to the “%s” field.',
    'Поле «%s» обязательно.' => 'The “%s” field is required.',
    'Некорректный e-mail адрес.' => 'Invalid email address.',
    'Некорректный номер телефона (не менее 7 цифр, без букв).' => 'Invalid phone number (at least 7 digits, no letters).',
    'Превышена максимальная длина сообщения (не более 2000 символов).' => 'The message is too long (maximum 2000 characters).',
    'Проверьте правильность заполнения формы.' => 'Please check the form fields.',
    ...
    'Согласие на использование cookie' => 'Cookie consent',
    'Мы используем cookie для аналитики. Продолжая, вы соглашаетесь с их использованием.' => 'We use cookies for analytics. By continuing, you agree to their use.',
    'Принять' => 'Accept',
    'Отклонить' => 'Decline',
