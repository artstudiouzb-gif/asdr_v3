...
// Медиатека — часть работы с контентом, а не инструмент рядом с корзиной и
// шаблонами: в неё заходят из формы новости и страницы, то есть посреди той же
// задачи. Стоит последней в группе — это библиотека, а не раздел материалов.
