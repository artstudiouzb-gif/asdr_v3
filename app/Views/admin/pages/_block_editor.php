...
?>
    ...
    <div class="form-card u-inline-8a359a76eb">
        <h3 class="u-inline-291b7bbb01">Шаблоны страницы</h3>
        <p class="form-hint">Шаблон сохраняет все блоки этого языка, включая содержимое колонок. Его можно применить к любой странице: добавить к текущим блокам или полностью заменить их. Перед заменой прежние блоки автоматически сохраняются как «Автокопия: …» — хранятся последние 5. Вся библиотека — в разделе <a href="/admin/snippets">«Шаблоны страниц»</a>: там видно состав и вес каждого, там же они переименовываются и удаляются.</p>
