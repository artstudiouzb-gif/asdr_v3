 ...
 * ссылается на slug o-nas, поэтому ссылки не ломаются. Страницы руководства
 * фикстура не содержит — их собирают в админке.
 */
...
if (!$dryRun) {
    fwrite(STDOUT, "Кэш страниц сброшен. Проверьте /o-nas.\n");
}
