 ...
 * страница с формой, поиск, 404, сама витрина и вход в портал /repo — в светлой и тёмной теме, на
...
const SCREENS = [
    ...
    // Портал файлов живёт на своём макете и слоя «Дизайна» не получает:
    // у него действуют числа из :root темы, а не настройки. Без учётки портала
    // доступен только вход (/repo уводит на него) — его и снимаем.
