...
function quality_budgets(): array
{
    return [
        'public_important' => [
            ...
            // 449 → 367 после уборки → 366 замером отчёта: потолок опущен под
            // факт в том же коммите, где отчёт этот запас и показал.
            'ceiling' => static fn (): int => 366,
