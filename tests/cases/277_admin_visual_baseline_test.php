...
test('Визуальные регрессы админки: фикстура, спека и эталон на месте', function (): void {
    ...
    // Тем панели больше нет — есть настройка внешнего вида, и закрепляемых
    // состояния по-прежнему два: светлое и тёмное.
    assert_contains('data-admin-appearance', $spec, 'снимаем оба состояния внешнего вида');
