 ...
 *
 * Здесь проверяется именно подбор: цвет надписи — следствие заливки. Своё
 * поле у слайда с тех пор появилось (`cta_text_color`), и выбор редактора
 * подбор перебивает — как у акцентной цитаты; нечитаемую пару форма называет
 * вслух, а не подменяет молча.
 */
