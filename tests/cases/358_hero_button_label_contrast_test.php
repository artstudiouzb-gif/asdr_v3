...
test('Без своего цвета кнопки обложка не трогает --on-accent', function () {
    // Заливка приходит из «Дизайна» (`--color-accent`), и надпись к ней уже
    ...
    $css = hero_button_css([]);
    assert_contains('--hero-accent:var(--color-accent)', $css, 'без своего цвета кнопка берёт акцент сайта');
